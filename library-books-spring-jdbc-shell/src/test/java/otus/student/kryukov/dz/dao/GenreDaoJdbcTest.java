...
public class GenreDaoJdbcTest {
    ...
    void getByGenreTest() {
        ...
        assertEquals(genre, genreDao.getByGenre("poem"), "Error getting Genre-row by genre");
    ...
    void getByGenreIdTest() {
        Genre genre = new Genre(3L, "poem");
        assertEquals(genre, genreDao.getByGenreId(3L), "Error getting Genre-row by genre_id");
