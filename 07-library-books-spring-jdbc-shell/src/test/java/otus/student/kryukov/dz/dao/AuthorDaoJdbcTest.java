...
public class AuthorDaoJdbcTest {
    ...
    void getByAuthorTest() {
        Author authorObject = new Author(2L, "James White");
        assertEquals(authorObject, authorDao.getByAuthor("James White"), "Error getting Author-row by author");
    ...
    void getByAuthorIdTest() {
        Author authorObject = new Author(2L, "James White");
        assertEquals(authorObject, authorDao.getByAuthorId(2L), "Error getting Author-row by author_id");
